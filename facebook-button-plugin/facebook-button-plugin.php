...
if ( ! function_exists( 'fcbkbttn_enqueue_scripts' ) ) {
	...
	function fcbkbttn_enqueue_scripts() {
        wp_enqueue_style( 'fcbkbttn_icon', plugins_url( 'css/icon.css', __FILE__ ), false, '1.0' );
        if ( isset( $_GET['page'] ) && ( 'facebook-button-plugin.php' === $_GET['page'] || 'social-buttons.php' === $_GET['page'] ) ) {
			bws_enqueue_settings_scripts();
			bws_plugins_include_codemirror();
			wp_enqueue_script( 'fcbkbttn_script', plugins_url( 'js/admin-script.js', __FILE__ ), array( 'jquery' ), '1.0', true );
            wp_enqueue_media();
			wp_localize_script(
				'fcbkbttn_script',
				'fcbkbttn_var',
			...
			wp_enqueue_style( 'fcbkbttn_stylesheet', plugins_url( 'css/style.css', __FILE__ ), false, '1.0' );
		} elseif ( ! is_admin() ) {
			wp_enqueue_style( 'fcbkbttn_stylesheet', plugins_url( 'css/style.css', __FILE__ ), false, '1.0' );
			wp_enqueue_script( 'fcbkbttn_script', plugins_url( 'js/script.js', __FILE__ ), array( 'jquery' ), '1.0', true );
		}
	}
}
