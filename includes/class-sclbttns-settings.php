...
if ( ! class_exists( 'Sclbttns_Settings_Tabs' ) ) {
	/**
	 * Class Sclbttns_Settings_Tabs for Setting tab
	 */
	class Sclbttns_Settings_Tabs extends Bws_Settings_Tabs {
		...
		public function __construct( $plugin_basename ) {
			...
			$tabs = array(
				...
				'messengers'  => array( 'label' => 'Messengers' ),
				'display'     => array(
					'label'  => __( 'Display', 'social-buttons-pack' ),
					'is_pro' => 1,
				),
			...
			require_once dirname( dirname( __FILE__ ) ) . '/includes/sclbttns-mssngrs-settings.php';
			$this->mssngrs_page = new Mssngrs_Settings_Tabs( plugin_basename( __FILE__ ) );
		}
		 ...
		 * Messengers tab
		 */
		public function tab_messengers() {
			$this->mssngrs_page->tab_settings();
		}
		...
		public function tab_display() { ?>
			<h3 class="bws_tab_label"><?php esc_html_e( 'Display Settings', 'social-buttons-pack' ); ?></h3>
			...
			<div class="bws_pro_version_bloc">
				<div class="bws_pro_version_table_bloc">
					...
					<table class="form-table bws_pro_version">
						<tr>
							<td colspan="2">
								<?php esc_html_e( 'Please choose the necessary post types (or single pages) where Social Suttons will be displayed:', 'social-buttons-pack' ); ?>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<label>
									...
									<?php esc_html_e( 'Show URL for pages', 'social-buttons-pack' ); ?>
								</label>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<img src="<?php echo esc_url( plugins_url( 'images/pro_screen_1.png', dirname( __FILE__ ) ) ); ?>" alt="<?php esc_html_e( 'Example of site pages tree', 'social-buttons-pack' ); ?>" title="<?php esc_html_e( 'Example of site pages tree', 'social-buttons-pack' ); ?>" />
							</td>
						</tr>
					</table>
				</div>
